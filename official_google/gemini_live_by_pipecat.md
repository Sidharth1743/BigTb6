...
<ParamField path="model" type="str" default="models/gemini-2.5-flash-native-audio-preview-12-2025">
...
<ParamField path="params" type="InputParams" default="InputParams()">
  Runtime-configurable generation and session settings. See [InputParams](#inputparams) below.
</ParamField>
...
cd server && source .venv/bin/activate && python bot.py -t webrtc --host localhost --port 7860